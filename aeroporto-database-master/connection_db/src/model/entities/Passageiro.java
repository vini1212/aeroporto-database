...
public class Passageiro implements Serializable{
	...
	public Passageiro(Integer idPassageiro, String pNome, String mNome, String sNome, String passaporte, Integer idade,
			Voo nVooPassageiro) {
	...
	public String toString() {
		return "Passageiro -> ID: " + idPassageiro + " - Nome: " + pNome + ", Nome do Meio: " + mNome + ", Sobrenome: " + sNome
				+ " - Idade=" + idade + " - Passaporte=" + passaporte + " - Numero do Voo" + nVooPassageiro;
	}
}
